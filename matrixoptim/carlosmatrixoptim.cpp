...
void heep_svd_model2()
{
  ...
  a0_err = sqrt(Vinv[0][0]);    //uncertainty in dEb/Eb offset
  a1_err = sqrt(Vinv[1][1]);    //uncertainty in dEf/Ef offset
  a2_err = sqrt(Vinv[2][2]);    //uncertainty in dth_e offset
  a3_err = sqrt(Vinv[3][3]);    //uncertainty in dth_p offset
